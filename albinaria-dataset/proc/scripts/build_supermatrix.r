...
# Usage:
# Rscript --vanilla build_supermatrix.r LOCI_DIR FILTER_FILE PREFIX OUTPUT_DIR
...
OUTPUT_MSA = paste(output_dir, OUTPUT_MSA, sep="/")
if (FORMAT == 0) {
...
if (length(args) != 4) {
  stop("Arguments: LOCI_DIR FILTER_FILE PREFIX OUTPUT_DIR", call.=FALSE)
}
